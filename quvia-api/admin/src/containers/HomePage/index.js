        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              >
                {msg => <h2 id="mainHeader">Welcome to Republik Administration!</h2>}
              </FormattedMessage>
              {hasAlreadyCreatedContentTypes ? (
                <FormattedMessage id="app.components.HomePage.welcomeBlock.content.again">
                  {msg => <P>The Next-Generation Creator Platform, Powered By Blockchain Technology.</P>}
                </FormattedMessage>
              ) : (
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <FormattedMessage id="HomePage.community">{msg => <h2>Go Back to Website</h2>}</FormattedMessage>
              <div></div>
              <FormattedMessage id="HomePage.roadmap">
                {msg => (
                  <ALink
                    rel="noopener noreferrer"
                    href="https://www.republik.io/"
                    target="_blank"
                  >
                    RepubliK Website
                  </ALink>
